...
// app.use(express.static(__dirname + "/second.html"));
// app.use(express.static(__dirname + "/third.html"));
// app.use(express.static(__dirname + "/fourth.html"));
// app.use(express.static(__dirname + "/fifth.html"));
// app.use(express.static(__dirname + "/panda.jpg"));
